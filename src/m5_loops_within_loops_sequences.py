...
def run_test_integers():
    ...
    # Test 2:
    expected = [3, 2, 4, 13, 10, 1, 25, 3, 4, 301, -4]
    answer = integers([(3, 2, 4),
                       (13, 'hi', 10),
                       [1, 25, 's', 3, 4],
                       'h',
                       [],
...
def run_test_big_letters():
    ...
    # Test 2:
    expected = 'OATSSOOPSABCPSWOSKOPYOO'
    answer = big_letters([(3, 2, 4),  # not a string
                          'Ok whAt is ThiSS?',  # OATSS
                          (10, 'Ok what is ThiSSS?', 20, 10),  # not a string
                          [],  # not a string
                          ['ooPs'],  # not a string
                          'oOps',  #O
                          ['OOPS'],  # not a string
