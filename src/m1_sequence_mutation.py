...
def run_test_zero_changer():
    ...
    # ------------------------------------------------------------------
    # Test 2:
    test2 = ([8, 4, 2, 9], [0, 1, 0, 1, 0, 0], [4, 4, 4], [4, 0, 4])
    expected2 = ([8, 4, 2, 9], [1, 1, 2, 1, 3, 4], [4, 4, 4], [4, 5, 4])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 3:
    test3 = ([0, 0, 0, 9], [7, 0, 3, 1, 5, 4], [4, 4, 4], [4, 0, 4])
    expected3 = ([1, 2, 3, 9], [7, 4, 3, 1, 5, 4], [4, 4, 4], [4, 5, 4])
    zero_changer(test3)
    print()
    print('Test 3:')
